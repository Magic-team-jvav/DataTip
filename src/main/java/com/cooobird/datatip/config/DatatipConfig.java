...
public class DatatipConfig {
     ...
     * </p>
     */
    public static final ModConfigSpec.EnumValue<ColorPreset> DEFAULT_COLOR = BUILDER
     ...
     * 自定义默认文本颜色。
     */
    public static final ModConfigSpec.ConfigValue<String> DEFAULT_COLOR_VALUE = BUILDER
     ...
     * </p>
     */
    public static final ModConfigSpec.EnumValue<ColorPreset> SHIFT_HINT_COLOR = BUILDER
     ...
     * 自定义 Shift 提示文字颜色。
     */
    public static final ModConfigSpec.ConfigValue<String> SHIFT_HINT_COLOR_VALUE = BUILDER
     ...
     * </p>
     */
    public static final ModConfigSpec.EnumValue<ColorPreset> SCROLL_HINT_COLOR = BUILDER
     ...
     * 自定义滚动提示文字颜色。
     */
    public static final ModConfigSpec.ConfigValue<String> SCROLL_HINT_COLOR_VALUE = BUILDER
    ...
    private static int resolveColor(
        ModConfigSpec.EnumValue<ColorPreset> preset,
        ModConfigSpec.ConfigValue<String> customValue,
        int fallback
    ) {
        try {
