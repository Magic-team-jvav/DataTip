...
final class PreparedContainerSupport {
    ...
    private static final class Frame {
        ...
        private void initialize() {
            initialized = true;
            if (content instanceof TipNode(TipContent inner, com.cooobird.datatip.api.node.TipModifiers modifiers)) {
                ...
                children.add(new Frame(
                    inner,
                    TipModifierLayout.childContext(context, modifiers)
                ));
                return;
            }
