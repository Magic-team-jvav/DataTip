 ...
 * ImageContent 解析器�?
 * <p>
 * 负责�?JSON 对象解析�?{@link ImageContent} 实例�?
 ...
 *   <tr><td>textureWidth</td><td>int</td><td>width</td><td>纹理总宽�?/td></tr>
 *   <tr><td>textureHeight</td><td>int</td><td>height</td><td>纹理总高�?/td></tr>
 *   <tr><td>scale</td><td>float</td><td>1.0</td><td>缩放倍数</td></tr>
 *   <tr><td>align</td><td>String</td><td>"left"</td><td>对齐方式（left/center/right�?/td></tr>
 * </table>
 *
 * @author cooobird
 * @see ImageContent 图片内容�?
 * @since 1.2.0
 */
public class ImageContentParser implements ContentParser {
    ...
    public ImageContent parse(JsonObject json, ParseContext context) {
        ...
        return new ImageContent(texture, width, height, u, v, textureWidth, textureHeight, scale, offsetX, offsetY);
    }
}
